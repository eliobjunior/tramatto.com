window.catalogData = {
  ...
  products: [
    {
      ...
      brand: 'Tramatto',
      condition: 'new',
      productType: 'Panos de Louça > Essentials > Linho Anatoliano',
    ...
    },
    {
      ...
      brand: 'Tramatto',
      condition: 'new',
      productType: 'Panos de Louça > Signature > Borda Dourada',
      googleProductCategory: 'Home & Garden > Kitchen & Dining > Kitchen & Dining Linens > Dish Towels',
      inStock: true,
      stock: 9,
      colors: ['Areia'],
    ...
    },
    {
      ...
      brand: 'Tramatto',
      condition: 'new',
      productType: 'Panos de Louça > Essentials > Listrado Clássico',
      googleProductCategory: 'Home & Garden > Kitchen & Dining > Kitchen & Dining Linens > Dish Towels',
      inStock: true,
      stock: 11,
    ...
    },
    {
      ...
      brand: 'Tramatto',
      condition: 'new',
      productType: 'Panos de Louça > Signature > Jacquard Ottomano',
      googleProductCategory: 'Home & Garden > Kitchen & Dining > Kitchen & Dining Linens > Dish Towels',
      inStock: false,
      stock: 0,
      colors: ['Creme'],
  ...
  kits: [
    ...
    },
    {
      ...
      description: 'Mix de padrões e texturas para quem enxerga os panos de louça como peça de decoração.',
      price: 'R$ 230,00',
      tag: 'Kit · 5 peças',
